...
string4 = "python"
# Your code here
print("The position of 'th' in the word 'python' is", string4.find("th"))
...
# Your code here
if string9.isupper():
    print("PYTHON is in all uppercase.")
...
string16 = "python"
# Your code here
if string16.startswith("py"):
    print("python starts with 'py'")
